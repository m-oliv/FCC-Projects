...
var stuff = {"k" : "117asdf01asd3c397726059952b18544", "b" :  "d1851bc227", "r" : "asdf01asd3"};

function getK() {
    "use strict";
    return stuff.k.replace(stuff.r, stuff.b);
}
...
function getWindDir(angle) {
    ...
    return dir[Math.round((angle / 45))];
...
function getUnits(country) {
    ...
    switch (country) {
        ...
        case country === "KY":
        case country === "KW":
        case country === "MM": units = "imperial"; break;
        default: units = "metric"; break;
    }
    return units;
}
...
function getWeatherIconBG(weatherID){
    ...
    switch(weatherID){
        ...
        case 800: 
        case 951: 
            $('body').css('background-image', "url(\"https://farm9.staticflickr.com/8660/16712341612_1acf44685c_o_d.jpg\")");
            icon.innerHTML = "<i id =\"weatherIcon\" class = \"wi wi-day-sunny\"></i>";
            document.getElementById('weatherInfo').insertBefore(icon,document.getElementById('weatherInfo').firstChild);
            break;
            // mist / haze / fog
        case 701:
        case 721:
        case 741: $('body').css('background-image',"url(\"http://wallpaperus.org/wallpapers/05/205/dock-fog-1920x1080-wallpaper-874500.jpg\")");
...
function getCurrentTime(){
    "use strict";
    var d = new Date(), h = d.getHours(),min = d.getMinutes();
    if(h < 10){
        h = "0"+d.getHours();
    }
...
function titleCase(str) {
    "use strict";
    var s1 = str.toLowerCase(), s = s1.split(" ");
